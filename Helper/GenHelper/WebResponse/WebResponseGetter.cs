...
namespace GenHelper.WebResponse
{
    public class WebResponseGetter
    {
        
        public WebResponseGetter()
        {
        ...
        public string GetMimeType(string extension)
        {
            ...
            string defaultmimeType = "application/unknown";
            switch (extension.ToLower())
            {
                ...
                #endregion
                default: return defaultmimeType;
            }
        }

        public void ShowResponseMimeType(string fileName,byte[] filebyte,HttpResponseMessage httpResponse)
        {
            string guidid = Guid.NewGuid().ToString();
            string fileNameOnly = Path.GetFileNameWithoutExtension(fileName);
            string extensionOnly = Path.GetExtension(fileName).Replace(".","");
            //fileName = ConstantaHelper.GetInstance.LocalPath + fileNameOnly + guidid + "." + extensionOnly;
            //httpResponse.res
            //HttpContext
            ...
            //    string x_FolderUpload = string.Empty;
            //    x_FolderUpload = PGI.FileDownload + "/" + FTPGetYear(Year) + @"/" + folderDownloadAddress;
            //    //FilePath = HostingEnvironment.MapPath(x_FolderUpload + @"\" + fileName);
            //    FilePath = x_FolderUpload + @"\" + fileName;
            ...
            //    /*
            //     Delete File Download Temp File
            //     */
